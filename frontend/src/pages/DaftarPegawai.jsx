import { useEffect, useState } from 'react'; import axios from 'axios'; import Sidebar from '../components/Sidebar';

const DaftarPegawai = () => { const [pegawai, setPegawai] = useState([]); const [filteredTim, setFilteredTim] = useState([]); const [filteredNama, setFilteredNama] = useState([]); const [pengaduan, setPengaduan] = useState([]);

const [selectedSeksi, setSelectedSeksi] = useState(''); const [selectedTim, setSelectedTim] = useState(''); const [selectedNama, setSelectedNama] = useState('');
